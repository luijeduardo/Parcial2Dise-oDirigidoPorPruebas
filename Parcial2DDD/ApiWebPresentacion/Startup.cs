...
namespace ApiWebPresentacion
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ParcialContext>
                (opt => opt.UseSqlServer("Server=DESKTOP-GP31J4O;Database=Parcial;Trusted_Connection=True;MultipleActiveResultSets=true"));
            ...
            services.AddScoped<IDbContext, ParcialContext>(); //Se Instancia un peticion
